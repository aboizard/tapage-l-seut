...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003017dca600007fbb8c86ea16(
...
class phpbbtemplatetwiglexer_000000003017dca600007fbb8c86ea16 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d1914d54c745809022338 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d1914d54c75d265972169 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d1914d54c703657445661 = array(
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, 'set_environment', array('env' => $env), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;

        return $this->valueHolder5d1914d54c745809022338->set_environment($env);
    }
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;

        return $this->valueHolder5d1914d54c745809022338->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;

        return $this->valueHolder5d1914d54c745809022338->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d1914d54c75d265972169 = $initializer;
    }
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, '__get', array('name' => $name), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;

        if (isset(self::$publicProperties5d1914d54c703657445661[$name])) {
            return $this->valueHolder5d1914d54c745809022338->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d1914d54c745809022338;
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, '__isset', array('name' => $name), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, '__unset', array('name' => $name), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;
    ...
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, '__clone', array(), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;

        $this->valueHolder5d1914d54c745809022338 = clone $this->valueHolder5d1914d54c745809022338;
    }

    public function __sleep()
    {
        $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, '__sleep', array(), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;

        return array('valueHolder5d1914d54c745809022338');
    }
    ...
    {
        return $this->initializer5d1914d54c75d265972169;
    }
    ...
    {
        return $this->initializer5d1914d54c75d265972169 && ($this->initializer5d1914d54c75d265972169->__invoke($valueHolder5d1914d54c745809022338, $this, 'initializeProxy', array(), $this->initializer5d1914d54c75d265972169) || 1) && $this->valueHolder5d1914d54c745809022338 = $valueHolder5d1914d54c745809022338;
    }
    ...
    {
        return null !== $this->valueHolder5d1914d54c745809022338;
    }
    ...
    {
        return $this->valueHolder5d1914d54c745809022338;
    }
