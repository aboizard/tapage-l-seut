...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004fd6df9f00007fbbd6fb0f6e(
...
class phpbbtemplatetwiglexer_000000004fd6df9f00007fbbd6fb0f6e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d1916213be88370721676 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d1916213beb8350311482 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d1916213be10642151349 = array(
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, 'set_environment', array('env' => $env), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;

        return $this->valueHolder5d1916213be88370721676->set_environment($env);
    }
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;

        return $this->valueHolder5d1916213be88370721676->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;

        return $this->valueHolder5d1916213be88370721676->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d1916213beb8350311482 = $initializer;
    }
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, '__get', array('name' => $name), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;

        if (isset(self::$publicProperties5d1916213be10642151349[$name])) {
            return $this->valueHolder5d1916213be88370721676->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d1916213be88370721676;
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, '__isset', array('name' => $name), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, '__unset', array('name' => $name), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;
    ...
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, '__clone', array(), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;

        $this->valueHolder5d1916213be88370721676 = clone $this->valueHolder5d1916213be88370721676;
    }

    public function __sleep()
    {
        $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, '__sleep', array(), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;

        return array('valueHolder5d1916213be88370721676');
    }
    ...
    {
        return $this->initializer5d1916213beb8350311482;
    }
    ...
    {
        return $this->initializer5d1916213beb8350311482 && ($this->initializer5d1916213beb8350311482->__invoke($valueHolder5d1916213be88370721676, $this, 'initializeProxy', array(), $this->initializer5d1916213beb8350311482) || 1) && $this->valueHolder5d1916213be88370721676 = $valueHolder5d1916213be88370721676;
    }
    ...
    {
        return null !== $this->valueHolder5d1916213be88370721676;
    }
    ...
    {
        return $this->valueHolder5d1916213be88370721676;
    }
