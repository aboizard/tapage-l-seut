...
if [ -f $1 ]; then
    ...
    convert $1 -resize 400x200 -gravity South -background Black -fill white -splice 0x18 -draw "text 0,2 '$format : $resolution - $size'" $DIR/miniature/$name-thumb.$extension
